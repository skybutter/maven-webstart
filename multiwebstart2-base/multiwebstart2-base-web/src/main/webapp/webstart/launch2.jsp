...
<%!
public static final String mainjar = "multiwebstart2-base-client";
public static final String childapp = "/multiwebstart2-child-web";
...
public java.util.Set<java.lang.String> getResourcePaths() {
	synchronized (this) {
		if (resources==null || resources.isEmpty()) {
			...
			// Sample output:
			// resources(/webstart/=[/webstart/commons-lang-2.1.jar, /webstart/launch.jsp, /webstart/multiwebstart2-child-client-1.0.jar]
