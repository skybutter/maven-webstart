...
3. Generate the jnlp as jsp with jsp code to set the codebase
...
c:\"Program Files (x86)\Java\jre1.7.0_51\bin\javaws.exe" http://localhost:8080/swingwebstart2-web/webstart/launch.jsp
