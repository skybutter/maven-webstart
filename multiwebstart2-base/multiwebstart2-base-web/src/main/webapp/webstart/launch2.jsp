...
String mainjar = "multiwebstart2-base-client";
...
// resourcePaths(/webstart/=[/webstart/commons-lang-2.1.jar, /webstart/launch.jsp, /webstart/multiwebstart2-base-client-1.0.jar]
%>
...
javax.servlet.ServletContext context = application.getContext("/multiwebstart2-child-web");
